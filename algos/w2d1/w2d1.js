...
// the flaming ruins of my functional solution
// const intersec = (arr1, arr2) => {
//     const map1 = {};
//     const deduped1 = arr1.filter(i => map1.hasOwnProperty(i) ? false : (seen[item] = true));

//     return arr2.filter(e this.indexOf(e) < 0)
// }
